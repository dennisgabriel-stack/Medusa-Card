...
import { MapPin, Navigation, ExternalLink, Mail, Clock } from "lucide-react";
      ...
      <main className="relative min-h-screen">
        ...
        <section className="px-4 sm:px-6 pb-10 max-w-2xl mx-auto">
          ...
          >
            ...
            >
              {/* Map preview area */}
              <div className="relative h-40 bg-gradient-to-br from-dark-elevated via-dark-card to-dark-elevated flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0 greek-pattern-overlay opacity-10" />
                <div className="relative flex flex-col items-center">
                  <div className="w-14 h-14 rounded-full bg-gold/10 border border-gold/30 flex items-center justify-center mb-2 group-hover:bg-gold/20 transition-colors">
